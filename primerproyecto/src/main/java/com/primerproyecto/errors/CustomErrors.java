package com.primerproyecto.errors;
...
public class CustomErrors {
    ...
    public void numeroParametrosIncorrecto(String posicion){
        System.out.println(msgError + msgLine + posicion + "; Numero de parametros incorrecto" + msgSemantico);
    }
    ...
    public void retornoDistintoTipo(String posicion){
        System.out.println(msgWarning + msgLine + posicion + "; Estas retornando un tipo de dato distinto" + msgSemantico);
    }
    ...
    public void idDiferenteTipoRetorno(String posicion, String id){
        System.out.println(msgError + msgLine + posicion + "; '" + id + "' es diferente del tipo de retorno" + msgSemantico);
    }
